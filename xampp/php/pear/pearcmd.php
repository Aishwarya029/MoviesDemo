...
if ('C:\Users\91776\Desktop\work\VScode\movies\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\91776\Desktop\work\VScode\movies\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
