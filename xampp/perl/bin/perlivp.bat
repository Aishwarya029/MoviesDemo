...
#!perl
#line 29
    eval 'exec C:\Users\91776\Desktop\work\VScode\movies\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\91776\Desktop\work\VScode\movies\xampp\perl\bin\perl.exe';
