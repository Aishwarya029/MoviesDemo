...
insert into movie values("2","1","BM2","BatmanReturns(1992).jpg","Batman Returns (1992)");
insert into movie values("3","1","BM3","BatmanForever(1995).jpg","Batman Forever (1995)");
insert into movie values("4","1","BM4","Batman&Robin(1997).jpg","Batman & Robin (1997)");
insert into movie values("5","1","BM5","BatmanBegins(2005).jpg","Batman Begins (2005)");
insert into movie values("6","1","BM6","TheDarkKnight(2008).jpg","The Dark Knight (2008)");
insert into movie values("7","1","BM7","TheDarkKnightRises(2012).jpg","The Dark Knight Rises (2012)");
...
insert into movie values("16","2","HP7","HarryPotterandtheDeathlyHallows–Part1.jpg","Harry Potter and the Deathly Hallows – Part 1");
insert into movie values("17","2","HP8","HarryPotterandtheDeathlyHallows–Part2.jpg","Harry Potter and the Deathly Hallows – Part 2");
